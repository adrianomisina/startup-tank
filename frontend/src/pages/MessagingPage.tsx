...
const MessagingPage: React.FC = () => {
  ...
  return (
    <Layout showSidebar={true}>
      <div className="bg-slate-50 h-[calc(100vh-64px)] flex p-4 sm:p-6 overflow-hidden">
        <div className="max-w-7xl mx-auto w-full flex bg-white rounded-[2.5rem] shadow-xl shadow-slate-200 overflow-hidden border border-slate-100">
          {/* Contacts List */}
          <div className="hidden sm:flex w-80 border-r border-slate-100 flex-col">
            <div className="p-6 border-b border-slate-100">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Mensagens</h2>
              <div className="relative">
                <Search className="absolute left-3 top-2.5 text-slate-400" size={18} />
                <input
                  type="text"
                  placeholder="Buscar conversas..."
                  className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-50 border-transparent focus:bg-white focus:border-slate-200 outline-none transition-all text-sm"
                />
              </div>
            </div>
            <div className="flex-1 overflow-y-auto">
              {contacts.map(contact => (
                <div
                  key={contact.id}
                  className={`p-6 flex items-center gap-4 cursor-pointer hover:bg-slate-50 transition-all ${contact.active ? 'bg-blue-50/50 border-r-4 border-blue-600' : ''}`}
                >
          ...
          <div className="flex-1 flex flex-col bg-slate-50/30">
            ...
            <div className="p-4 sm:p-6 bg-white border-b border-slate-100 flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-bold text-slate-900">Carlos Silva</div>
            ...
            <div className="flex-1 p-4 sm:p-8 overflow-y-auto space-y-6">
              <div className="flex justify-center">
                <span className="bg-white px-4 py-1 rounded-full text-[10px] font-bold text-slate-400 uppercase tracking-widest border border-slate-100 shadow-sm">
                  Hoje
                </span>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-sm border border-slate-100 max-w-xs sm:max-w-md">
              ...
              <div className="flex gap-4 flex-row-reverse">
                ...
                <div className="bg-blue-600 p-4 rounded-2xl rounded-tr-none shadow-lg shadow-blue-100 max-w-xs sm:max-w-md">
            ...
            <div className="p-4 sm:p-6 bg-white border-t border-slate-100">
              <form className="flex gap-4 items-center" onSubmit={e => e.preventDefault()}>
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-50 rounded-xl outline-none focus:bg-white focus:border-slate-200 border border-transparent transition-all text-sm sm:text-base"
                />
